...
i.e. high Precedence valued operators will be evaluated before lower valued ones.
...
======= =========================== =========== ========== ========
\+       Added A to B               `A + B`     1          :math:`\left(A + B\right)`
\-       Subtract B from A          `A - B`     1          :math:`\left(A - B\right)`
...
^       Raise A to the B'th power   `A ^ B`     3          :math:`A^{B}`
&       Logical AND of A and B      `A & B`     1          :math:`\left(A \land B\right)`
\|       Logical OR of A and B      `A | B`     1          :math:`\left(A \lor B\right)`
!       Logical NOT of A            `!A`        0          :math:`\not{A}`
======= =========================== =========== ========== ========
...
**root**  B'th root of A              `root(A,B)` :math:`\sqrt[B]{A}`
