...
def equation_extend():
    ...
    addOp('**', "({0:s} ^ {1:s})", "{0:s}^{{{1:s}}}", False, 1, op.pow)
    addOp('&&', "({0:s} && {1:s})", "\\left({0:s} \\land {1:s}\\right)", False, 6,
          lambda a, b: bool(a) and bool(b))
    addOp('||', "({0:s} || {1:s})", "\\left({0:s} \\lor {1:s}\\right)", False, 6,
    ...
    if has_numpy:
        ...
        addFn('arcsin', "arcsin({0:s})", "\\arcsin\\left({0:s}\\right)", 1, np.arcsin)
        addFn('arccos', "arccos({0:s})", "\\arccos\\left({0:s}\\right)", 1, np.arccos)
        addFn('arctan', "arctan({0:s})", "\\arctan\\left({0:s}\\right)", 1, np.arctan)
        ...
        addFn('arcsin', "arcsin({0:s})", "\\arcsin\\left({0:s}\\right)", 1, math.asin)
        addFn('arccos', "arccos({0:s})", "\\arccos\\left({0:s}\\right)", 1, math.acos)
        addFn('arctan', "arctan({0:s})", "\\arctan\\left({0:s}\\right)", 1, math.atan)
